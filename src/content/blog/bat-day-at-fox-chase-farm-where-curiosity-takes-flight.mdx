...
Controlled Environment Agriculture, often called CEA, is a method of growing plants in enclosed spaces where temperature, humidity, light, and nutrients are carefully managed. This approach allows crops to grow year round in urban environments using less water and less land than traditional farming. Students participating in CEA programs learn about engineering, plant biology, energy systems, and food technology.

The CEA initiative that Dr Manna and Harry Hayman are developing for the School District of Philadelphia will bring indoor farming and hydroponic systems into classrooms across the city. These programs teach students how to build, maintain, and innovate sustainable food systems. The lessons go beyond agriculture to include entrepreneurship, design, and teamwork. The goal is to connect urban education with local food production while inspiring the next generation of problem solvers and innovators.
